# Vendored from oh-my-zsh plugins/git/git.plugin.zsh (omz dropped 2026-07).
# Helpers below inlined from omz lib/git.zsh.

# Use GIT_OPTIONAL_LOCKS=0 so prompt/alias helpers never take repo locks
